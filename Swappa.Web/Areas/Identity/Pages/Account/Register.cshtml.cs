...
namespace Swappa.Web.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if(emailexist != null){
                    ...
                    return Redirect("/Admin/Dashboard/CreateUser");
                }
                var user = CreateUser();
                ...
                if (result.Succeeded)
                {
                    ...
                    if (Input.Role == null) {
                        ...
                        if (User.IsInRole(WebsiteRole.Admin)){
                            ...
                            return Redirect("/Admin/Dashboard/ManageUsers");
                        }
                        else {
                            Console.WriteLine("Sth else");
